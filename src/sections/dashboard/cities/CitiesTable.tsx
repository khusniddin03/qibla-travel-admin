...
import { deleteCity } from "./cities.api";
...
interface IProps {
    ...
    error: any;
    count: number;
    rowClick: (data: ICity) => void;
    setEditItemValue: (value: ICity | null) => void;
    editItemValue: ICity | null;
...
const CitiesTable = ({
    ...
    const { mutateAsync, isLoading: deleteIsLoading } = useMutation((id: number) => deleteCity(id));
